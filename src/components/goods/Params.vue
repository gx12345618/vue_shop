  ...
  <div>
    ...
    <el-card>
      ...
      <el-row class="cat_opt">
        <span>选择商品分类: </span>
        <!-- 级联选择框 -->
        <el-cascader v-model="selectdCateKeys" expand-trigger="hover" :options="cataList" :props="cateProps" @change="handleChange"></el-cascader>
      </el-row>
      <!-- tab 页签区 -->
    ...
    <el-dialog :title="'添加' + titleText" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px">
        <el-form-item :label="titleText" prop="addForm.attr_name">
...
export default {
  data() {
    return {
      ...
      // 添加参数的表单数据对象
      addFormRules:{
          attr_name:[{require:true,message:"请输入参数名称",trigger:'blur'}]
      },
      // 控制修改对话框的显示和隐藏
  ...
  methods: {
    ...
    async getParamsData() {
      ...
      res.data.forEach((item) => {
        ...
        // 控制文本框的显示和隐藏
        // 解决文本框联动的效果(每一行都共用了用一个布尔值和value)
