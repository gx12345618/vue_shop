        ...
        <el-tabs :tab-position="'left'" v-model="activeIndex" :before-leave="beforeTabLevae" @tab-click="tabClicked">
          <el-tab-pane label="基本信息" name="0">
            ...
            <el-form-item label="商品分类" prop="goods_cat">
              <el-cascader v-model="addForm.goods_cat" expand-trigger='hover' :options="cateList" :props="cateProps" @change="handleChange"></el-cascader>
            </el-form-item>
          </el-tab-pane>
  ...
  data() {
    return {
      ...
      addFormRules: {
        ...
        goods_cat: [{ required: true,message:'请输入商品参数',trigger:'blur'}],
      },
      // 存放商品列表数据
      cateList: [],
      cateProps: {
